  ...
  return (
    <div className="w-full lgl:w-1/2 flex flex-col gap-20">
      <div className="flex flex-col gap-5">
        ...
        Track your player's performance with our innovative player statistics tracking and forecasting 
        feature! Organize your games, trainings and more using our user-friendly software!
        </p>
      </div>
